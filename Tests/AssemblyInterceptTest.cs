...
{
    [TestFixture]
    public class AssemblyInterceptTest
    {
        ...
        public virtual void Setup_Fixture()
        {
            ...
            ImporterFactory = new AssemblyImporterFactory(AssemblyIntercept.Definition);
        }
        ...
        public void Should_find_type_that_should_be_intercepted_in_test_assembly()
        {
            ...
            var typeDefinition = AssemblyIntercept.FindType(typeToFind);
        ...
        {
            var inspector = new AssemblyIntercept(typeof (Type).Assembly);
        ...
        public void Should_throw_if_type_not_found()
        {
            ...
            AssemblyIntercept.FindType(typeThatCannotBeFound);
        }
        ...
        {
            new AssemblyIntercept("Some assembly that does not exist");
        }
    }
}
