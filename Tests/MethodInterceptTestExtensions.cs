...
{
    public static class MethodInterceptTestExtensions
    {
        ...
        public static void AssertResultsFor(this Assembly assembly, MethodInterceptTestMethodInfo info)
        {
            MethodInfo methodInfo;
            var interceptCount = 0;
            MethodInvocation methodInvocation = null;
            if (info is MethodInterceptTestMethodGenericInfo)
            {
                var genericInfo = ((MethodInterceptTestMethodGenericInfo) info);
