...
{
    public class MethodInterceptTestMethodInfo
    {
        ...
        public MethodInterceptTestMethodInfo(Type type, string methodName, object[] methodArgs = null, Action<MethodInvocation> invocation = null, Action<object> assertion = null)
        {
            this.type = type;
