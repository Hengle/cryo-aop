...
namespace CryoAOP.Core.Methods
{
    internal class Method
    {
        ...
        public void InterceptMethod(MethodInterceptionScopeType interceptionScope = MethodInterceptionScopeType.Shallow)
        {
            ...
            var v2 = new VariableDefinition("V_2", Context.Importer.Import(typeof (MethodInvocation)));
            ...
            var methodInvocationTypRef = Context.Importer.Import(typeof (MethodInvocation));
                ...
                il.Append(new[]
                              {
                                  ...
                                  il.Create(OpCodes.Callvirt,
                                            Context.Importer.Import(typeof (MethodInvocation), "get_Result")),
            ...
            il.Append(new[]
                          {
                              il.Create(OpCodes.Ldloc_2),
                              il.Create(OpCodes.Callvirt,
                                        Context.Importer.Import(typeof (MethodInvocation), "get_CanInvoke")),
                    ...
                    il.Append(new[]
                                  {
                                      ...
                                      il.Create(OpCodes.Callvirt,
                                                Context.Importer.Import(typeof (MethodInvocation), "set_Result"))
                                  });
                }
                else
                {
            ...
            il.Append(new[]
                          {
                              ...
                              il.Create(OpCodes.Call,
                                        Context.Importer.Import(typeof (MethodInvocation), "ContinueInvocation"))
                          });
